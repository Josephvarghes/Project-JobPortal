...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('images', models.FileField(blank=True, null=True, upload_to='multiple_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('short_reel', models.FileField(blank=True, null=True, upload_to='shortreels/')),
                ('created_date', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('multiple_images', models.ManyToManyField(blank=True, null=True, related_name='user_images', to='accounts.multipleimages')),
                ('qualification', models.ManyToManyField(related_name='user_qualification', to='accounts.qualification')),
                ('short_reel', models.ManyToManyField(blank=True, null=True, related_name='user_reels', to='accounts.shortreels')),
            ],
            options={
                'verbose_name': 'user',
